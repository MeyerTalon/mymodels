...
- Package layout: `<pkg>/{architecture,data,tokenizer,training,inference,utils}.py`, configs in `<pkg>/configs/*.yaml`, tests in `<pkg>/tests/`, per-model docs in `docs/README-<pkg>.md` at the repo root
